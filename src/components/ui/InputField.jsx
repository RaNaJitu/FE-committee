        ...
        <label className={`block text-left ${className}`} htmlFor={id}>
            ...
            <div className="relative mt-2">
                <input
                    ...
                    className={`w-full rounded-lg border border-white/20 bg-white/10 px-3 py-2 pr-10 text-sm text-white placeholder:text-white/50 transition focus:border-white focus:outline-none focus:ring-2 focus:ring-white/50 ${inputClassName}`}
                    required={required}
